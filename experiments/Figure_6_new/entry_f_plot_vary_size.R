...
obtain_median_BNTR_iter <-function(case = 1, n = 500){
  path = str_c("./SimResults/ise_BNTR_",n,"_20230918.Rdata")
  load(path)
...
obtain_hat_curve <- function(n=500){
  ...
  path = str_c("./SimResults/BNTR_", n, "_20230918.Rdata")
  load(path)
  y_hat_all_list = list()
  for(iter in 1:50){
...
library(stringi)
library(stringr)
#save_name = str_c("entrywise_plots_20230918", qtile, ".png")
save_name = str_c("entrywise_plots_20230918.png")
