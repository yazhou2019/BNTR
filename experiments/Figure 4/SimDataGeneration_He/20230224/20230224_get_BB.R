...
BBprod_l2norm[[2]] = BBprod[[2]] * f1l2norm + BBprod[[8]]* f2l2norm  + BBprod[[9]] * f5l2norm
BBprod_l2norm[[3]] = BBprod[[3]] * f2l2norm + BBprod[[4]] * f2l2norm
BBprod_l2norm[[4]] = BBprod[[5]] * f3l2norm + BBprod[[6]] * f5l2norm
BBprod_l2norm[[5]] = BBprod[[7]] * f4l2norm
