...
wrapper <- function(idx) {
  ...
  load(str_c("./TLR1/TLR1_", n_use,"_20230918.Rdata"))
  #load(str_c("./SimResults/Simul_n", n_use,"_rep50_final_fix_new.Rdata"))
  
  
  #load("./SimResults/TLR2_1000_linear_new_20230302.Rdata")
  load("./TLR1/SimResults/Simul_n1000_rep50_final_fix_new_editor.Rdata")
  BB_list = data_all[[51]]
  ...
  for(signal_i in 1:5){
    ...
    knots_used = NA #result[[idx]][[signal_i+15]]
    #BBv = result[[idx]][[signal_i+20]]
    vv = 1 #result[[idx]][[signal_i+25]]
...
sfSource('./TLR1/parallel_source_TLR1.R')
...
sfStop()
filename <- str_c("ise_TLR1_", n_use, "_20230918.Rdata")
setwd("./TLR1")
