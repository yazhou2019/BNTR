...
Max_iter = max(Max_iter, fit_nonlinear$num)
...
res=list(max_iter=Max_iter, BB=BBbig_nonlinear[[index_best]],MSE_vali=b_validation_test_lambda_R_nonlinear[index_best,2],MSE_pre=b_validation_test_lambda_R_nonlinear[index_best,3],knots=knots,BBbig_nonlinear=BBbig_nonlinear,b_validation_test_lambda_R_nonlinear=b_validation_test_lambda_R_nonlinear,bb=b_validation_test_lambda_R_nonlinear[index_best,1])  
