...
for(n_i in 2:4){
  ...
  if(n==250){
    ...
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/MSE_ISE/res_mat250K4butterfly.Rdata")
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/SimResults/BNTR250_butterfly_K4.Rdata")
    result_5 = result
  ...
  if(n ==500 || n==750){
    ...
    if(n==500){
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/SimResults/BNTR500_butterfly_K5.Rdata")
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/MSE_ISE/res_mat500K5butterfly.Rdata")
    }
    if(n==750){
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/SimResults/BNTR750_butterfly_K5.Rdata")
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/MSE_ISE/res_mat750K5butterfly.Rdata")
    }
    result_5 = result
    res_mat_f[,5] = res_mat[,5]
  ...
  if(n==1000){
    ...
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/SimResults/BNTR1000_butterfly_K7.Rdata")
    load("/Users/zhouya/Desktop/JRSSBreview2/upload_JRSSB_2nd_respond/NewResults/MSE_ISE/res_mat1000K7butterfly.Rdata")
    result_5 = result
    res_mat_f[,5] = res_mat[,5]
