...
wrapper <- function(idx) {
  ...
  for(samplesize_i in 2:4){
    ...
    if(n==250){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_250_linear_new_beta.Rdata"
    }
    if(n==500){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_500_linear_new_beta.Rdata"
    }
    if(n==750){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_750_linear_new_beta.Rdata"
    }
    if(n==1000){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_1000_linear_new_beta.Rdata"
    }
    ...
    for(signal_i in 1:5){
      ...
      for(iter in idx){
        ...
        fun_diff_ten = functionpart_diff_ten_linear(BB, case=signal_i, precision=1000)
...
sfStop()
filename <- str_c("ise_meta_beta_n250_500_750_1000_linear_beta.Rdata")
