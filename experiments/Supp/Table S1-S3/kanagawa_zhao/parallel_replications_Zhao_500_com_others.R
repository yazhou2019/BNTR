...
wrapper <- function(idx) {
  ...
  for(signal_i in 2){
    ...
    id_test=501:1000 # test is useless here
    ...
    BB_idx[[signal_i+12]]=res$res_mat
    BB_idx[[signal_i+16]]=res$KXX_base_train
  }
  return(BB_idx)
}

sfSource('./ParallelComput/parallel_source_500_com_others_Zhao.R')
...
sfStop()
filename <- str_c("BNTR", n_use, "_new_com_others_Zhao.Rdata")
setwd("./SimResults")
