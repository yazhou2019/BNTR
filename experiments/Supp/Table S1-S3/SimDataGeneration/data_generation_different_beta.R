...
#X_data_SNR = array(rtnorm(64*64*10000, mean=0.5, sd=1, lower=0, upper=1),c(64,64,10000))
X_data_SNR = array(rbeta(64*64*10000, 1.25,1.25),c(64,64,10000))
...
y_SNR[[5]]=1+t(ctprod(BBprod_butterfly,X_datacross_reg_SNR[[2]],2))
