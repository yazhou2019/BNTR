...
y_train=y_data(:,1:n_train,iter);
y_vali=y_data(:,((1000-n_vali+1):1000),iter);
y_test=y_vali;
...
csvwrite('MSE_all_1000_grid.csv',MSE_all)
save('BB_all_1000_grid.mat','BB_all')
save('b0_all_1000_grid.mat','b0_all')
