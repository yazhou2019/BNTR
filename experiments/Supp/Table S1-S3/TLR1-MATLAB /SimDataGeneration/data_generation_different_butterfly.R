...
#X_datacross_reg_SNR = X_data_SNR
X_datacross_reg_SNR=X_data_SNR+adjust_nonlinear*sin(2*pi*(X_data_SNR-0.5)^2)
...
y_SNR=1+t(ctprod(BBprod,X_datacross_reg_SNR,2))
sigma_use=sigma*sqrt(var(y_SNR))
