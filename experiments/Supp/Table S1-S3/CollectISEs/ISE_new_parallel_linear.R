...
wrapper <- function(idx) {
  ...
  for(samplesize_i in 1:4){
    ...
    if(n==250){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_250_linear_new_tnorm.Rdata"
    }
    if(n==500){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_500_linear_new_tnorm.Rdata"
    }
    if(n==750){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_750_linear_new_tnorm.Rdata"
    }
    if(n==1000){
      path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/TLR2_1000_linear_new_tnorm.Rdata"
    }
...
sfStop()
filename <- str_c("ise_meta_tnorm_n250_500_750_1000_linear.Rdata")
