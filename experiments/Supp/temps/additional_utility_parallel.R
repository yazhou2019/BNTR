load("/data/yzhou/BNTR/FullSimPaper/CollectISEs/true_signal/B1.Rdata")
load("/data/yzhou/BNTR/FullSimPaper/CollectISEs/true_signal/B2.Rdata")
load("/data/yzhou/BNTR/FullSimPaper/CollectISEs/true_signal/B3.Rdata")
load("/data/yzhou/BNTR/FullSimPaper/CollectISEs/true_signal/B41.Rdata")
load("/data/yzhou/BNTR/FullSimPaper/CollectISEs/true_signal/B42.Rdata")
load("/data/yzhou/BNTR/FullSimPaper/CollectISEs/true_signal/butterfly.Rdata")
library(msm)
CASE1 = B1
CASE2 = B2
CASE3 = B3
...
ftrue_and_hat_plot <-function(BB, i, j, case=2, knots=c(0, 0.25, 0.5, 0.75, 1)){
  ...
  group = c(rep('true', precision), rep('estimation', precision))
...
functionpart_diff_ten_linear <- function(BB, case=1, precision=1000){
