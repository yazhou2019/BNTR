...
wrapper <- function(idx) {
  ...
  if(n==250){
    path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/BNTR250_beta_K4.Rdata"
  }
  if(n==500){
    path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/BNTR500_beta_K5.Rdata"
  }
  if(n==750){
    path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/BNTR750_beta_K5.Rdata"
  }
  if(n==1000){
    path1 = "/data/yzhou/BNTR/FullSimPaper/SimResults/BNTR1000_beta_K7.Rdata"
  }
  
  load(path1)
  set.seed(idx*100)
  #X = array(rtnorm(64*64*1000, mean=0.5, sd=0.25, lower=0, upper=1),c(64,64,1000))
  X = array(rbeta(64*64*1000, 1.2, 1.2),c(64,64,1000))
...
sfStop()
filename <- str_c("ise_meta_beta_n500_750_1000.Rdata")
