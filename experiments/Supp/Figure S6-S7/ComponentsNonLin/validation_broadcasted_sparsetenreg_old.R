  ...
  for(i1 in 1:num_R){
    for(i2 in 1:num_alpha){
      for(i3 in 1:num_lambda){
        ...
        MSE_nonlinear_validation=prediction_function_nonlinear(b0,BB,tildePhiX_vali,y_vali,family='gaussian',binomial=1)
        #MSE_nonlinear_validation=predict_BroadcasTR(b0,BB,tildePhiX_vali,y_vali,family='gaussian')
        MSE_nonlinear_test=prediction_function_nonlinear(b0,BB,tildePhiX_test,y_test,family='gaussian',binomial=1)
