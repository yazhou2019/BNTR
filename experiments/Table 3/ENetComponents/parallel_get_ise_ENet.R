...
wrapper <- function(idx) {
  ...
  datasetname = str_c("./SimResults/ENet_", n_use, "_new_20230103.Rdata")
  #load("./SimResults/ENet_500_new_20230103.Rdata")
  load(datasetname)
  ...
  for(signal_i in 1:5){
    ...
    ise_mat[1, signal_i] = final_ise_linear(b0=bb, BB=BB, BBv=BBv, v =vv, case=signal_i, precision=1000, knots = knots_used, order = 4)$ise
...
sfStop()
filename <- str_c("ise_ENet", n_use, "_new_K8_20221222.Rdata")
setwd("./SimResults")
