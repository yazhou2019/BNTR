...
#'
#' @param X_sample The training input with basis transformation; the tensor of size \eqn{ p_1 \times \cdots \times p_D \times (K-1) \times n}
#' @param y The training output. a vector of size \eqn{n}
